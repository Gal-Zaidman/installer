...
module "affinity_group" {
  ...
  ovirt_cluster_id            = var.ovirt_cluster_id
  ovirt_masters_affinity_groups_names = var.ovirt_masters_affinity_groups_names
  ovirt_cluster_affinity_groups_names = var.ovirt_cluster_affinity_groups_names
  masters_ids = module.masters.masters_ids
}
